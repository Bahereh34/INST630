...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        statusMessage.textContent ="Loading restaurant data ... Please wait.";
        ...
        try {
            ...
            statusMessage.textContent="Dalat loaded successfully!";
        ...
        try {
            ...
            <div class="status-display error">
                <p class="status-message">
                    Failed to load data. This is a simulated error. Please check your connection or try again.
                </p>
